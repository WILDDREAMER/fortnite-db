<?php 
    ...
    if(isset($_POST['android_verify_btn'])){
        ...
        if($_POST['envato_buyer_name']!='' AND $envato_buyer->buyer==$_POST['envato_buyer_name'] AND ($envato_buyer->item->id=='7054658' OR $envato_buyer->item->id=='20239372'))
        {
            $data = array(
        ...
        if($_POST['envato_buyer_name']!='' AND $envato_buyer->buyer==$_POST['envato_buyer_name'] AND ($envato_buyer->item->id=='15134376' OR $envato_buyer->item->id=='20239372'))
        {
                ...
                <div class="col-md-12">
                    <div class="section">
                      <div class="section-body">
                        <p><strong>API URL:</strong> <?=$file_path?></p>
                        <hr/>
             ...
             <form action="" name="ios_verify" method="post" class="form form-horizontal" enctype="multipart/form-data" id="api_form">
              ...
              <div class="rows">
                <div class="col-md-12">
                    <div class="section">
                      <div class="section-body">
                        <p><strong>API URL:</strong> <?=$ios_file_path?></p>
                        <hr/>
                        <div class="form-group">
                          <label class="col-md-4 control-label">Envato Username :-
                            <p class="control-label-help" style="margin-bottom: 5px">https://codecanyon.net/user/<u style="color: #e91e63">viaviwebtech</u></p>
