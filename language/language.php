<?php
	  ...
	  $client_lang['20'] = "Enable on home successfully"; 

	  $client_lang['21'] = "Disable on home successfully!"; 

	  $client_lang['22'] = "Set to slider successfully"; 

	  $client_lang['23'] = "Remove to slider successfully!"; 
